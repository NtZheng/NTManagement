...
- (void)viewDidLoad {
    ...
    MJRefreshNormalHeader *header = [MJRefreshNormalHeader headerWithRefreshingBlock:^{
        ...
        [[NTAFNetworking shareAFNetworkingService] doGetRequest:[NTFlowURL(self.fileName) stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLQueryAllowedCharacterSet]] result:^(id responseObject, NSError *error) {
